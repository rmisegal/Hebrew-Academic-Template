...
\hline
\mixedcell{\textbf{שם / \en{Name}}} & \mixedcell{\textbf{ערך / \en{Value}}} & \mixedcell{\textbf{יחידה / \en{Unit}}} \\
\hline
\mixedcell{מהירות / \en{Speed}} & \num{100} & \en{km/h} \\
\hline
\mixedcell{טמפרטורה / \en{Temperature}} & \num{25.5} & \en{°C} \\
\hline
\mixedcell{דיוק / \en{Accuracy}} & \percent{98.7} & \mixedcell{אחוזים / \en{Percent}} \\
\hline
\mixedcell{זמן / \en{Time}} & \num{3.14} & \mixedcell{שניות / \en{Seconds}} \\
\hline
\end{rtltabular}
\end{hebrewtable}

כפי שניתן לראות בטבלה, הפקודה \texttt{mixedcell} מאפשרת שילוב נוח של עברית ואנגלית באותו תא.
...
\begin{pythonbox}[חישוב ממוצע: \en{Calculate Average}]
...
\fbox{\parbox{8cm}{
    \centering
    \vspace{2cm}
    {\Large דוגמת איור}\\[0.5cm]
    \en{Sample Figure}\\[0.5cm]
    (מקום לתמונה)\\
    \vspace{2cm}
}}
