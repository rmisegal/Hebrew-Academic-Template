% ================================================
% IMAGE EXAMPLE - Hebrew Academic Template v5.0
% ================================================
...
\englishtitle{Image and Figure Example - Hebrew Academic Template v5.0}
...
\end{tabular}
\caption{רשת איורים 2×2: \entoc{2×2 Figure Grid}}
\label{fig:grid}
\end{figure}
