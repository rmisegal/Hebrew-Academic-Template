...
\textbf{הבעיה:} ב-\LaTeX{}, האפשרויות \texttt{[h]}, \texttt{[t]}, \texttt{[b]}, \texttt{[p]} הן \emph{הצעות} בלבד.
\LaTeX{} עלול להתעלם מהן ולהזיז איורים לעמודים מאוחרים יותר, במיוחד כאשר האיורים גדולים.
...
\begin{enumerate}
    ...
    \begin{verbatim}
    \hebrewfigure[H]{...}{כיתוב}
    \end{verbatim}
\end{enumerate}

\textbf{השוואת אפשרויות מיקום:}
\begin{itemize}
    \item \texttt{[h]} -- כאן (הצעה, \LaTeX{} עלול להתעלם)
