% ================================================
% BIBLIOGRAPHY EXAMPLE - Hebrew Academic Template
% ================================================
...
\englishtitle{Bibliography Example - Hebrew Academic Template \clsversion}
...
\hebrewsubsection{שימוש ב-\en{keywords}: \entoc{Using Keywords}}

כל מקור בקובץ ה-\en{\texttt{.bib}} צריך לכלול:
\begin{itemize}
    \item \en{\texttt{keywords=\{hebrew\}}} למקורות בעברית
    \item \en{\texttt{keywords=\{english\}}} למקורות באנגלית
...
מחקר / \en{Study} & שנה / \en{Year} & תרומה / \en{Contribution} \\
...
\cite{hebrew_nlp_2023} & \hebyear{2023} & עיבוד עברית \\
\end{tblr}
\end{table}
...
\begin{itemize}
    ...
    \item שימוש ב-\en{\texttt{keywords}} להפרדת שפות
\end{itemize}
