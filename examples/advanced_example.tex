...
\hline
\hebheader{\textbf{ממוצע / \en{Average}}} &
\hebheader{\textbf{מענה / \en{QA}}} &
\hebheader{\textbf{סיכום / \en{Summarization}}} &
\hebheader{\textbf{תרגום / \en{Translation}}} &
\hebheader{\textbf{סיווג / \en{Classification}}} &
\hebheader{\textbf{מודל / \en{Model}}} \\
\hline
\hline
...
\hline
\percent{83.9} & \percent{86.7} & \percent{81.2} & \percent{78.5} & \percent{89.3} & \hebcell{מודל עברי / \en{HeBERT}} \\
\hline
\end{rtltabular}%
}
\end{hebrewtable}
...
\hline
\hebheader{\textbf{עלות / \en{Cost}}} &
\hebheader{\textbf{זמן אימון / \en{Training Time}}} &
\hebheader{\textbf{זיכרון / \en{Memory}}} &
\hebheader{\textbf{פרמטרים / \en{Parameters}}} &
\hebheader{\textbf{מודל / \en{Model}}} \\
\hline
