...
\hline
\mixedcell{\textbf{יחידה / \en{Unit}}} & \mixedcell{\textbf{ערך / \en{Value}}} & \mixedcell{\textbf{שם / \en{Name}}} \\
\hline
\en{km/h} & \num{100} & \mixedcell{מהירות / \en{Speed}} \\
\hline
\en{°C} & \num{25.5} & \mixedcell{טמפרטורה / \en{Temperature}} \\
\hline
\mixedcell{אחוזים / \en{Percent}} & \percent{98.7} & \mixedcell{דיוק / \en{Accuracy}} \\
\hline
\mixedcell{שניות / \en{Seconds}} & \num{3.14} & \mixedcell{זמן / \en{Time}} \\
\hline
\end{rtltabular}
\end{hebrewtable}
