...
\englishtitle{Beginner Example - Hebrew Academic Template \clsversion}
...
זהו מסמך דוגמה למתחילים המדגים את היכולות הבסיסיות של התבנית האקדמית העברית גרסה \en{\clsversion}.
...
להלן טבלה פשוטה המדגימה שימוש בסביבת \en{fancytable} לתאים עם תוכן מעורב:

\begin{fancytable}{ccc}{נתונים בסיסיים: \entoc{Basic Data}}
\textbf{יחידה / \en{Unit}} & \textbf{ערך / \en{Value}} & \textbf{שם / \en{Name}} \\
\en{km/h} & \en{100} & מהירות / \en{Speed} \\
\en{°C} & \en{25.5} & טמפרטורה / \en{Temperature} \\
אחוזים / \en{Percent} & \en{98.7}\en{\%} & דיוק / \en{Accuracy} \\
שניות / \en{Seconds} & \en{3.14} & זמן / \en{Time} \\
\end{fancytable}

כפי שניתן לראות בטבלה, סביבת \en{fancytable} מאפשרת שילוב נוח של עברית ואנגלית באותו תא.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{images/fig_beginner.pdf}
...
מסמך זה הדגים את היכולות הבסיסיות של התבנית האקדמית העברית גרסה \en{\clsversion}:

\begin{itemize}
    \item כתיבה בעברית עם שילוב אנגלית באמצעות \en{\texttt{\textbackslash en\{\}}}
    \item שימוש במספרים (\en{\texttt{\textbackslash num\{\}}}), שנים (\en{\texttt{\textbackslash hebyear\{\}}}), ואחוזים (\en{\texttt{\textbackslash percent\{\}}})
    \item יצירת סעיפים ותת-סעיפים עם \en{\texttt{\textbackslash entoc\{\}}} לתוכן העניינים
    \item טבלאות עם תוכן מעורב באמצעות סביבת \en{fancytable}
    \item הוספת קוד עם \en{\texttt{pythonbox}}
    \item ציטוטים ביבליוגרפיים
    \item איורים וביטויים מתמטיים
    \item סעיפים באנגלית עם \en{\texttt{\textbackslash startenglish}} ו-\en{\texttt{\textbackslash stopenglish}}
\end{itemize}
