...
זהו מסמך דוגמה למתחילים המדגים את היכולות הבסיסיות של התבנית האקדמית העברית גרסה \clsversion.
...
מסמך זה הדגים את היכולות הבסיסיות של התבנית האקדמית העברית גרסה \clsversion:
