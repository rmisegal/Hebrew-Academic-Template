% ================================================
% FOOTNOTE EXAMPLE - Hebrew Academic Template
% ================================================
...
\englishtitle{Footnote Example - Hebrew Academic Template \clsversion}
...
\begin{fancytable}{ccc}{טבלה עם הערות שוליים: \entoc{Table with Footnotes}}
\textbf{הערה / \en{Note}} & \textbf{ערך / \en{Value}} & \textbf{שם / \en{Name}} \\
רגיל & \en{100} & פריט א\footnote{הערה לפריט א.} \\
מיוחד & \en{200}\footnote{ערך זה נמדד ב-\en{2025}.} & פריט ב \\
חשוב\footnote{ראה פירוט בנספח.} & \en{300} & פריט ג \\
\end{fancytable}
...
\fbox{\parbox{12cm}{
    \centering
    \vspace{0.5cm}
    \includegraphics[width=10cm]{images/fig_footnote_diagram.pdf}\\[0.3cm]
    דיאגרמה עם הערה\footnotemark\\
    \vspace{0.3cm}
}}
\caption{איור עם הערת שוליים: \entoc{Figure with Footnote}}
\end{figure}
\footnotetext{הערת שוליים מתוך איור - מקרה מיוחד. שימו לב: הערות שוליים בתוך איורים דורשות שימוש ב-\en{\textbackslash footnotemark} בתוך האיור ו-\en{\textbackslash footnotetext} מחוצה לו.}

\hebrewsubsection{הערות בנוסחאות: \entoc{Footnotes in Equations}}

נוסחה מתמטית עם הערה\footnote{המשוואה המפורסמת של איינשטיין.}:
\begin{equation}
E = mc^2
\end{equation}
