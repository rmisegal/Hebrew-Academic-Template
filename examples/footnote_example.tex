...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{images/fig_footnote_diagram.pdf}
\caption{איור עם הערת שוליים\footnote{הערת שוליים מתוך איור - מקרה מיוחד.}: \entoc{Figure with Footnote}}
\end{figure}
